...
const cableProductImages = [
  ...
  "https://res.cloudinary.com/deywq723/image/upload/f_auto,q_auto/v1790186233/1_lvbsko.png",
  "https://res.cloudinary.com/deywq723/image/upload/f_auto,q_auto/v1790190293/1_bsbnn2.png",
  "https://res.cloudinary.com/deywq723/image/upload/f_auto,q_auto/v1790191139/1_i36aur.png",
  images.cable,
];
...
const products = [
  ...
  },
  {
    ...
    cableType: "c-to-c",
    color: "orange",
    filterId: "data-cable-connector",
    badge: "New",
  },
  {
    order: 8,
    name: "4 in 1 Data Cable Connector with Ignition",
    subtitle: "USB-A / Type-C multi cable with built-in ignition",
    image: cableProductImages[8],
    cableType: "multi",
    color: "black",
    filterId: "4-in-1-ignition",
    badge: "New",
  },
  {
    order: 9,
    name: "4 in 1 Magnetic Cable",
    subtitle: "1m 100W magnetic braided multi-connector cable",
    image: cableProductImages[9],
    cableType: "multi",
    color: "black",
    filterId: "4-in-1-magnetic",
    badge: "New",
  },
  {
    order: 10,
    name: "4 in 1 Portable Data Cable",
    subtitle: "Champagne gold keychain multi-connector cable",
    image: cableProductImages[10],
    cableType: "multi",
    color: "gold",
    filterId: "4-in-1-portable",
    badge: "New",
  },
];
...
const filterOptions = [
  ...
  { id: "blue", label: "Blue" },
  { id: "colourfull", label: "Colourfull C to C" },
  { id: "data-cable-connector", label: "Data Cable Connector" },
  { id: "4-in-1-magnetic", label: "4 in 1 Magnetic" },
  { id: "4-in-1-portable", label: "4 in 1 Portable" },
  { id: "4-in-1-ignition", label: "4 in 1 with Ignition" },
  { id: "new", label: "New" },
